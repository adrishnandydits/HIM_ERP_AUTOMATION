...
class PlacementPage:
    ...
    COMPANY = (
        By.XPATH,
        "//label[normalize-space()='Select Company']/following::select[1]"
    )
    ...
    def select_student(self):
        ...
        raise AssertionError(
            "No valid student option found or selected after waiting 30 seconds."
        )
    ...
    def click_edit_for_exact_row(self, expected_values):
        ...
        raise AssertionError(
            f"Edit button was not found for exact placement row. "
    ...
    def click_delete_for_exact_row(self, expected_values):
        ...
        raise AssertionError(
            f"Delete button was not found for exact placement row. "
            f"Expected values: {expected_values}. "
            f"Actual table text: {table_text}"
        )
