...
class DiscountScholarshipPage:
    ...
    SCHOLARSHIP_GROUP = (
        By.XPATH,
        "//label[contains(normalize-space(),'Select Scholarship group')]/following::select[1]"
    )
    ...
    GRANT_SEMESTER = (
        By.XPATH,
        "//label[contains(normalize-space(),'Choose Semester to Grant Scholarship')]/following::select[1]"
    )
    ...
    def select_type_scholarship(self):
        return self.select_by_visible_text(
            self.TYPE,
            "Scholarship",
            field_name="type",
    ...
    def select_scholarship_group_4000(self):
        return self.select_by_visible_text(
            self.SCHOLARSHIP_GROUP,
            "scholarship - 4000",
            field_name="scholarship group",
            timeout=35
        )
    ...
    def enter_scholarship_code(self, value):
        self.enter_text(self.SCHOLARSHIP_CODE, value)
    ...
    def select_student_checkbox_by_name(self, student_name, timeout=35):
        ...
        raise AssertionError(
            "\nDiscount/Scholarship Student Checkbox Selection Failed\n"
            "------------------------------------------------------\n"
    ...
    def search_discount_scholarship_table(self, value):
    ...
    def click_edit_for_exact_row(self, expected_values):
        ...
        raise AssertionError(
            f"Edit button was not found for exact discount/scholarship row. "
    ...
    def click_delete_for_exact_row(self, expected_values):
        ...
        raise AssertionError(
            f"Delete button was not found for exact discount/scholarship row. "
            f"Expected values: {expected_values}. "
            f"Actual table text: {table_text}"
        )
