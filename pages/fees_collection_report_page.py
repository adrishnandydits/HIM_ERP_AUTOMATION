...
class FeesCollectionReportPage:
    ...
    def select_course(self, course_name):
        self.select_by_visible_text(self.COURSE, course_name)

    def select_semester(self, semester_name):
        self.select_by_visible_text(self.SEMESTER, semester_name)
    ...
    def select_fees_type(self, fees_type):
        self.select_by_visible_text(self.FEES_TYPE, fees_type)
